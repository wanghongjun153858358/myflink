package com.red.stream.userPurchaseBehaviorTracker.function;

import com.red.stream.userPurchaseBehaviorTracker.model.*;
import com.red.stream.userPurchaseBehaviorTracker.start.Launcher;
...
public class ConnectedBroadcastProcessFunction extends KeyedBroadcastProcessFunction<String, UserEvent, Config, EvaluatedResult> {
    private Config defaultConfig = new Config("APP","2018-01-01",4,3);
