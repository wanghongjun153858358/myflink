...
public class TestReduceFunctionOnWindow {
    public static void main(String[] args) throws Exception{
        ...
        DataStream<Tuple3<String,String,Integer>>  totalPoints = input.keyBy(0).countWindow(3).reduce(new ReduceFunction<Tuple3<String, String, Integer>>() {
            @Override
            public Tuple3<String, String, Integer> reduce(Tuple3<String, String, Integer> value1, Tuple3<String, String, Integer> value2) throws Exception {
                return new Tuple3<>(value1.f0,"wanghongjun",value1.f2+value2.f2);
            }
        });
